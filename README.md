...
<br />
<p align="center">
  <a href="https://github.com/BNTFeujjj/CrowBot">
  ...
  <h3 align="center">BotifyHost CrowBot</h3>
...
2. Open up [config.json](https://discord.gg/Rq6mnAtuMc) with notepad or some other editor

# <a id="config"></a>⚙ » Config

If you want to change the config, open up [config.json](https://discord.gg/Rq6mnAtuMc) and locate it at the top. There you can configure the following:
